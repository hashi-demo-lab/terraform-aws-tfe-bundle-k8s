module "tfe" {
  ...
  product                   = var.product
  asg_max_size              = 3 # Set this in your separate workspace to deploy TFE.  This is just for an example of how to use this module with the deployment module
  asg_instance_count        = 3 # Set this in your separate workspace to deploy TFE.  This is just for an example of how to use this module with the deployment module
