# Public TFE (Replicated) single site with an ALB and RDS PostgreSQL Example
...
-  S3 buckets  
-  Regional RDS PostgreSQL cluster  
...
| <a name="input_tfe_release_sequence"></a> [tfe\_release\_sequence](#input\_tfe\_release\_sequence) | Version of TFE to deploy. | `string` | `"733"` | no |
