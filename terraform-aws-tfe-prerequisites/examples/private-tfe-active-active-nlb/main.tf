...
module "tfe" {
  ...
  redis_host                      = module.pre_req_primary.redis_primary_endpoint
  redis_password                  = module.pre_req_primary.redis_password
  redis_port                      = module.pre_req_primary.redis_port
  redis_security_group_id         = one(module.pre_req_primary.redis_security_group_ids)
  product                         = var.product
