# Public TFE (FDO) Active Active with an NLB Example
...
This module showcases an example of utilizing the root module of this repository to build out the following high level components for a Public TFE **active-active** deployment inside of AWS in a **specific region**:  
