...
variable "tfe_object_storage_s3_server_side_encryption_kms_key_id" {}
variable "tfe_redis_password" {}
variable "tfe_capacity_concurrency" { default = 100 }
variable "tfe_database_host" { default = "tfepg.c0ynn81zfwhe.ap-northeast-2.rds.amazonaws.com:5432" }
...
variable "tfe_object_storage_s3_bucket" { default = "hashicorp-tfe-s3-common" }
variable "tfe_object_storage_s3_endpoint" { default = "https://s3.ap-northeast-2.amazonaws.com" }
variable "tfe_object_storage_s3_region" { default = "ap-northeast-2" }
...
variable "tfe_redis_host" { default = "master.dpt-elasticache-cluster-common.aoqw37.apn2.cache.amazonaws.com" }
...
variable "image_tag" { default = "v202402-1" }
